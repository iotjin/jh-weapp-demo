...
1. usingComponents 添加
  "jh-input-bottom": "../../JhComponents/jh-input-bottom/index",

2. wxml 添加组件
<jh-input-bottom isShow='{{showBottomInputPop}' title="标题" maxLength='50' placeholder='请输入（不超过50字）' bindconfirm='confirm'>
</jh-input-bottom>
...
Component({
  ...
  lifetimes: {
    attached: function () {
      // 页面创建时执行
      // console.info('---jh-input-bottom loaded!---')
    },
    detached: function () {
      // 页面销毁时执行
      // console.info('---jh-input-bottom unloaded!---')
    },
  },
