...
Component({
  ...
  methods: {
    onClickLastBtn() {
      ...
      var centerText = ''
      if (timeType == 'year') {
        centerText = TimeUtils.Jh_getLastYear(this.data.centerText);
      }
      if (timeType == 'yearMonth') {
        centerText = TimeUtils.Jh_getLastYearMonth(this.data.centerText);
      }
      this.setData({
        centerText: centerText
      })
      this.triggerEvent('clickLastBtn', this.data.centerText);
    },
    onClickNextBtn() {
