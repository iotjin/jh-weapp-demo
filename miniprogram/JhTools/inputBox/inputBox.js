...
<inputBox title='输入框标题'
  ...
  <inputBox title='输入框标题' placeholder='(输入框占位符)' maxlength='10' bindinputCancel='onInputCancel' bindinputConfirm='onInputConfirm' wx:if='{{ showInputAlert }}' />
  <inputBox title='输入框标题' multiline placeholder='(输入框占位符)' maxlength='140' bindinputCancel='onInputCancel' bindinputConfirm='onInputConfirm' wx:if='{{ showInputAlert }}' />
